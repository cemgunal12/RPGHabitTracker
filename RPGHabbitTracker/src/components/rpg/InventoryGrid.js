...
import { useGame } from '../context/GameContext'; // Context'i import ettik
import { MaterialCommunityIcons } from '@expo/vector-icons'; // İkon çeşitliliği için
...
export default function InventoryGrid() {
  ...
  const handleSellRequest = (item) => {
    const sellPrice = Math.floor(item.price * 0.5); // Yarı fiyatına satılır
