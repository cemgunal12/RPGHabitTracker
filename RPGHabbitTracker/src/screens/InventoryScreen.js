...
export default function InventoryScreen() {
  ...
  // HATA ÖNLEYİCİ: gameState yüklenmediyse bekle
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        {/* --- EQUIPMENT SLOTS (Kuşanılanlar) --- */}
        <View style={styles.slotsGrid}>
            {slots.map((slot) => {
                // Bu slotta takılı eşya var mı?
                // Not: gameState.equippedItems undefined gelirse diye boş obje {} veriyoruz.
        ...
        {gameState.inventory.length === 0 ? (
            ...
            <View style={styles.inventoryGrid}>
                {gameState.inventory.map((item, index) => {
                    ...
                    // Bu eşya şu an takılı mı kontrol et
                    ...
                    return (
                        <TouchableOpacity 
                            ...
                            style={[
                                ...
                                isEquipped && styles.equippedItemOpacity // Takılıysa soluk göster
                            ]}
                            onPress={() => handleEquip(item)}
                            disabled={isEquipped} // Takılıysa tıklanmasın
                        >
...
const styles = StyleSheet.create({
  ...
  equippedItemOpacity: { opacity: 0.5 }, // Takılıysa soluklaşır
